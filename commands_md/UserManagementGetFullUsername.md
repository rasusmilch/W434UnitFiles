# UserManagementGetFullUsername

## Declaration

```ats
function UserManagementGetFullUsername(): string;
```
...
`UserManagementGetEnabled`, `UserManagementGetUserGroupName`, `UserManagementGetUsername`, `UserManagementLogoutUser`, `UserManagementUserIsAdmin`
