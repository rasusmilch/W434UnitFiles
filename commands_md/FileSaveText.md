...
```ats
function FileSaveText(Handle: integer): boolean;
```
...
Saves the Textfile specified by the handle "Handle".
...
`FileAddText`, `FileCloseText`, `FileGetText`, `FileGetTextLineCount`, `FileOpenText`
