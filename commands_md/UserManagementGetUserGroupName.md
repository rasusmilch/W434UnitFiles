# UserManagementGetUserGroupName

## Declaration

```ats
function UserManagementGetUserGroupName(): string;
```
...
Returns the name of the usergroup of the current user.
...
`UserManagementGetEnabled`, `UserManagementGetFullUsername`, `UserManagementGetUsername`, `UserManagementLogoutUser`, `UserManagementUserIsAdmin`
