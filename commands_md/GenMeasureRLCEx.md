...
```ats
function GenMeasureRLCEx(Parameters: tarray; Results: tcreatearray): boolean;
```

## Call pattern

```ats
GenMeasureRLCEx(Parameters, Results);
```

## Description

All options RLC measurement.

TParameter and hardware are dependent.
...
Parameters[RLC_PARAM_AutorangeMeas] = TRUE;
Parameters[RLC_PARAM_GenGuarded] = FALSE;
Parameters[RLC_PARAM_GenToJack] = FALSE;
Parameters[RLC_PARAM_GenToMatrix] = TRUE;
Parameters[RLC_PARAM_Floating] = FALSE;
Parameters[RLC_PARAM_Autosense] = FALSE;
Parameters[RLC_PARAM_WatchdogEnabled] = TRUE;
Parameters[RLC_PARAM_MeasBus] = MEASBUS_Sense;
Parameters[RLC_PARAM_Frequency] = 1kHz;
Parameters[RLC_PARAM_MaxVoltage] = 2V;
Parameters[RLC_PARAM_MaxCurrent] = 1mA;
Parameters[RLC_PARAM_Bias] = FALSE;
Parameters[RLC_PARAM_4Wire] = FALSE;
Parameters[RLC_PARAM_CCompensation] = 0nF;

GenMeasureRLCEx(Parameters,ResultValues);
...
`CreateMeasurementParameterList`, `GenDielectricBreakdownEx`, `GenMeasureResistanceEx`, `GenMeasureVoltageEx`
