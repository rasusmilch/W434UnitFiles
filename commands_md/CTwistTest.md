...
```ats
function CTwistTest(Name: string; Pin1: tpin; Pin2: tpin): boolean; tests ctwists;
```

## Call pattern

```ats
CTwistTest('Name', "Pin1", "Pin2");
```

## Description

Tests a C-twist between Pin1 and Pin2 with DC.
...
| `RES_Compensation` | `real` | Parameter: Compensation value in Farad |
