...
```ats
function RLCQualityTest(Name: string; Pin1: tpin; Pin2: tpin; Minimum: real; Maximum: real): boolean; tests rlccombinations;
```

## Call pattern

```ats
RLCQualityTest('Name', "Pin1", "Pin2", <Minimum>, <Maximum>);
```

## Description

The function tests the quality of a RLC combination.
...
```ats
RLCQualityTest('RLC 1 Q', "Pin1", "Pin2", 4, 6);
```
...
| `RES_Qmin` | `real` | Parameter: Minimum quality |
| `RES_Qmax` | `real` | Parameter: Maximum quality |
...
`MeasureRLC`, `RLCDissipationTest`, `RLCImpedanceAbsoluteTest`, `RLCImpedanceImaginaryTest`, `RLCImpedanceRealTest`, `RLCParallelCapacitanceTest`, `RLCParallelInductanceTest`, `RLCParallelResistanceTest`, `RLCPhaseAngleTest`, `RLCSerialCapacitanceTest`, `RLCSerialInductanceTest`, `RLCSerialResistanceTest`
