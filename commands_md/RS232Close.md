...
```ats
function RS232Close(Port: integer): boolean;
```
...
`RS232GetError`, `RS232Open`, `RS232ReceiveString`, `RS232SendString`, `RS232SetConfig`, `RS232SetParity`, `RS232SetTimeout`
