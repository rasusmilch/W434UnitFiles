...
```ats
function RS232SendString(Port: integer; Data: string): boolean;
```

## Call pattern

```ats
RS232SendString(Port, 'Data');
```

## Description

Sends the string "Data" to the RS232-Port "Port".
...
`RS232Close`, `RS232GetError`, `RS232Open`, `RS232ReceiveString`, `RS232SetConfig`, `RS232SetParity`, `RS232SetTimeout`
