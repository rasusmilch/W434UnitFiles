...
```ats
Button = UIMessageDialogYesNoEx('Do you like this?',
...
`UIMessageDialogCustomEx`, `UIMessageDialogOkCancelEx`, `UIMessageDialogYesNo`, `UIMessageDialogYesNoCancelEx`
