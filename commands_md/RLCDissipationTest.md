...
```ats
function RLCDissipationTest(Name: string; Pin1: tpin; Pin2: tpin; Minimum: real; Maximum: real): boolean; tests rlccombinations;
```

## Call pattern

```ats
RLCDissipationTest('Name', "Pin1", "Pin2", <Minimum>, <Maximum>);
```

## Description

The function tests the dissipation of a RLC combination.
...
```ats
RLCDissipationTest('RLC 1 Dissipation', "Pin1", "Pin2", 0.1, 0.3);
```
...
| `RES_Dismin` | `real` | Parameter: Minimum dissipation |
| `RES_Dismax` | `real` | Parameter: Maximum dissipation |
| `RES_Value` | `real` | Measured value |
...
`MeasureRLC`, `RLCImpedanceAbsoluteTest`, `RLCImpedanceImaginaryTest`, `RLCImpedanceRealTest`, `RLCParallelCapacitanceTest`, `RLCParallelInductanceTest`, `RLCParallelResistanceTest`, `RLCPhaseAngleTest`, `RLCQualityTest`, `RLCSerialCapacitanceTest`, `RLCSerialInductanceTest`, `RLCSerialResistanceTest`
