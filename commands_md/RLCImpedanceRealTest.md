# RLCImpedanceRealTest

## Declaration

```ats
function RLCImpedanceRealTest(Name: string; Pin1: tpin; Pin2: tpin; Minimum: tresistance; Maximum: tresistance): boolean; tests rlccombinations;
```

## Call pattern

```ats
RLCImpedanceRealTest('Name', "Pin1", "Pin2", <Minimum>Ohm, <Maximum>Ohm);
```

## Description

The function tests the real impedance of a RLC combination.
...
```ats
RLCImpedanceRealTest('RLC 1 Zr', "Pin1", "Pin2", 2900Ohm, 3100Ohm);
```
...
`MeasureRLC`, `RLCDissipationTest`, `RLCImpedanceAbsoluteTest`, `RLCImpedanceImaginaryTest`, `RLCParallelCapacitanceTest`, `RLCParallelInductanceTest`, `RLCParallelResistanceTest`, `RLCPhaseAngleTest`, `RLCQualityTest`, `RLCSerialCapacitanceTest`, `RLCSerialInductanceTest`, `RLCSerialResistanceTest`
