...
```ats
function DiodeTest(Name: string; Pin1: tpin; Pin2: tpin): boolean; tests diodes;
```

## Call pattern

```ats
DiodeTest('Name', "Pin1", "Pin2");
```

## Description

Tests a diode between Pin1 and Pin2.

The function always refers to a diode in the netlist.

[image: ..\..\images\DiodeCharacteristic.bmp]
...
`AttenuatorTest`, `CapacitorTest`, `DiodeTestCustom`, `MeasureRLC`, `ResistorTest`, `TestDiodes`, `ZDiodeTest`
