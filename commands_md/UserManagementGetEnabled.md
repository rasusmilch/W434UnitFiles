# UserManagementGetEnabled

## Declaration

```ats
function UserManagementGetEnabled(): boolean;
```
...
Returns TRUE if the user management is enabled, otherwise FALSE.
...
`UserManagementGetFullUsername`, `UserManagementGetUserGroupName`, `UserManagementGetUsername`, `UserManagementLogoutUser`, `UserManagementUserIsAdmin`
