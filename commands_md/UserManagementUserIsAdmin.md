# UserManagementUserIsAdmin

## Declaration

```ats
function UserManagementUserIsAdmin(): boolean;
```
...
Returns TRUE if the current user belongs to the user group "Administrators", otherwise FALSE.
...
`UserManagementGetEnabled`, `UserManagementGetFullUsername`, `UserManagementGetUserGroupName`, `UserManagementGetUsername`, `UserManagementLogoutUser`
