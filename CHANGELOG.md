...
- Added literal pin-name HV/DB exclusion helpers that honor native CEETIS per-pin test exclusions, provide optional report-visible selection-audit output, deduplicate complete modeled networks, and abort when exclusion results in zero attempted tests.
